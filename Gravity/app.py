...
# Main content
def main_page():
    # Gravity branding header at the top of main content
    st.markdown("""
    ...
    # Brief introduction
    st.markdown("""
    Welcome to Gravity, your all-in-one platform for monitoring, analyzing, and distributing 
    ...
    <div class="testimonial">
        "Gravity has transformed how our team monitors industry news. The newsletter generator saves us hours every week, and the search functionality helps us stay on top of competitor movements."
        <br><br>
        <strong>— BLK Teams.</strong>
    </div>
    """, unsafe_allow_html=True)
