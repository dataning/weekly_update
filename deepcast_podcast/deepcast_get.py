...
# from pathlib import Path
# from updated_transcript_processor import TranscriptProcessor  # Import from your saved module

# Create output directories
raw_folder = Path("raw_transcripts")
processed_folder = Path("processed_transcripts")
...
processor = TranscriptProcessor(raw_folder, processed_folder)

# Use the episode slug from the URL
episode_slug = "trump-rally-or-bessent-put-elon-back-at-tesla-googles-gemini-problem-chinas"

# Download and process the transcript
transcript_df = processor.get_data(episode_slug)

print(f"Downloaded transcript with {len(transcript_df)} segments")
